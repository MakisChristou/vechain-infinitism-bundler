...
class ExecutionManager {
    ...
    async sendUserOperation(userOp, entryPointInput) {
        await this.mutex.runExclusive(async () => {
            ...
            this.mempoolManager.addUserOp(userOp, userOpHash, validationResult.returnInfo.prefund, validationResult.senderInfo, validationResult.referencedContracts, (_a = validationResult.aggregatorInfo) === null || _a === void 0 ? void 0 : _a.addr);
