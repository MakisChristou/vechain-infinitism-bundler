...
async function main() {
    ...
    const provider = (0, ethers_1.getDefaultProvider)(opts.network);
    let signer;
    const deployFactory = opts.deployFactory;
    let bundler;
    ...
    const requiredBalance = (0, utils_1.parseEther)('10000000');
    ...
    const data = (0, utils_1.keccak256)(Buffer.from('test()')).slice(0, 10);
