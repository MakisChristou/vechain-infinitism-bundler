...
export interface TracerTestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "a" | "addr2int" | "b" | "callRevertingFunction" | "callTimeStamp" | "callWithValue" | "doNothing" | "execSelf" | "revertWithMessage" | "testCallGas" | "testKeccak"): FunctionFragment;
