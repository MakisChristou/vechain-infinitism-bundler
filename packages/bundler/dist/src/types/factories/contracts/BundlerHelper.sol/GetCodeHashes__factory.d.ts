...
import type { GetCodeHashes, GetCodeHashesInterface } from "../../../contracts/BundlerHelper.sol/GetCodeHashes";
type GetCodeHashesConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
export declare class GetCodeHashes__factory extends ContractFactory {
    ...
    attach(address: string): GetCodeHashes;
    connect(signer: Signer): GetCodeHashes__factory;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): GetCodeHashes;
}
export {};
