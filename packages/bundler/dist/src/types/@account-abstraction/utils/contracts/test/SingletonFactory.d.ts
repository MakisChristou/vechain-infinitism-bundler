...
export interface SingletonFactory extends BaseContract {
    ...
    functions: {
        deploy(_initCode: PromiseOrValue<BytesLike>, _salt: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        deploy(_initCode: PromiseOrValue<BytesLike>, _salt: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
        deploy(_initCode: PromiseOrValue<BytesLike>, _salt: PromiseOrValue<BytesLike>, overrides?: Overrides & {
